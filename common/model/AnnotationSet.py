...
class AnnotationSet:
    ...
    def is_FL(self):
        return self.plane_type == 'femur long-axis plane'

    def is_HC(self):
        return self.plane_type == 'thalamic transverse plane'

    def is_AC(self):
        return self.plane_type == "Horizontal cross-section of upper abdomen"

    def is_std(self):
        return self.std_type == 'standard'

    def is_astd(self):
        return self.std_type == 'basic standard'

    def is_nstd(self):
        return self.std_type == 'nonstandard'

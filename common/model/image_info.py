...
class ImageInfo:
    ...
    def __init__(self, image, frame_idx=0, queue_idx=0):
        ...
        self.replace_frame_num_in_video = 0  
        ...
        # first, second, third trimester, Gynecology ...
        self.FetalKind = None
        ...
        # Determine whether there are any nodules in the current frame
    ...
    def to_annotation_set(self, plane_name):
        ...
        results = self.detection_results
        # plane_name = db_id_to_name_map[self.class_type] if self.class_type in db_id_to_name_map else 'unknown'
        ...
        # anno_set = None
            ...
            if self.is_thyroid():
                plane_name = 'thyroid'
                if results['left_info'] and results['left_info'] != 'unknown':
    ...
    def is_thyroid(self):
        return self.FetalKind == 'thyroid'

    def is_earlier_measure(self):
        return self.FetalKind == 'gynae' and self.class_type == 309  

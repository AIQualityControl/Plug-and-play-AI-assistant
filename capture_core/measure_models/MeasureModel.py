...
class MeasureModel(QcModel):
    ...
    def measure_biometry(self, image_info):
        ...
        # 1. roi 
        roi_image, offset = self.get_roi_image_offset(image_info)  #get big bbox infor and offset
        self.offset = offset
    ...
    def get_relative_offset(self, image_info):
        """
        bbox offset relative to ROI
        """
        if self.is_detect_with_roi():
            offset = image_info.offset()  # if dicom，return ：0,0

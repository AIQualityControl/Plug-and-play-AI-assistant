...
class DoplerDetector:
    ...
    def convert_color_to_bin_image(cls, color_image, thresh=90):
        ...
        # Detect the overly bright green areas, with a high G value and an extremely low RB value.
        ...
        # The R value is relatively high, but the GB value is low and similar to it in the corresponding areas.
    ...
    def is_valid_color_bar(cls, color_bar_list):
        ...
        merged_color_bar = np.concatenate(color_bar_list, axis=0) 
        red_pixels = 0
        blue_pixels = 0

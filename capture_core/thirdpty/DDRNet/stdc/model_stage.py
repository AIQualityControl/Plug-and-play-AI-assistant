...
# from ..sync_bn.inplace_abn.bn import InPlaceABNSync as BatchNorm2d
...
def get_seg_model(cfg, **kwargs):
    ...
    model = BiSeNet('STDCNet1446', 2, pretrain_model=pretrained_path, use_boundary_8=True)
    return model


def build_model(checkpoint_path, pretrained=False):
    model = BiSeNet('STDCNet1446', 2, use_boundary_8=True)
    print('build stdc2 successfully')
    if pretrained:
...
#     # in_ten = torch.randn(1, 3, 640, 721).cuda()
